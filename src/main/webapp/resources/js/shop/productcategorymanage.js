$(function () {
    var shopId = 1;
    var listUrl = '/o2o_ssm/shopadmin/getproductcategorylist';
    var addUrl = '/o2o_ssm/shopadmin/addproductcategorys';
    var deleteUrl = '/o2o_ssm/shopadmin/removeproductcategory';
